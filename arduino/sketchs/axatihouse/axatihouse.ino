...
/*
  When the gas sensor detects the gas with high concentration, the buzzer
  emits a "tick,tick" alarm sound.
*/
void gasDetection(){
...
/*
  Photocell sensor, PIR motion sensor and LED. When at night, someone passes by, 
  LED is on; nobody is around, the LED is off
*/
void nightDetection(){
...
/*
  When steam sensor detects rains, the servo 2 will be activated, the window will 
  be closed automatically, otherwise, the window will be open
*/
void rainDetection(){
...
/*
  Insert soil humidity into plant pot, when the soil is too dry, 
  buzzer will alarm and you will get the notification on app.
*/
void humedityDetection(){
...
void odeToJoy()//play Ode to joy song
{
